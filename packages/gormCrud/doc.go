...
The `GormCrud[T] will:
- Automatically create a table for the model,
- Provide methods for CRUD operations: Save(), LoadWhere(), Delete(),
...
Example:
	...
	func main() {
		...
		err = instance.Delete(instance) // Delete
	}
...
Database Setup:
  - Uses SQLite with the specified database file.
